...
class ClothingsControllerTest < ActionController::TestCase
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post :create, clothing: { description: @clothing.description, price: @clothing.price, quantity: @clothing.quantity, type: @clothing.type }
    end
  ...
  test "should update clothing" do
    patch :update, id: @clothing, clothing: { description: @clothing.description, price: @clothing.price, quantity: @clothing.quantity, type: @clothing.type }
    assert_redirected_to clothing_path(assigns(:clothing))
  end
